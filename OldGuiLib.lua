...
local geticon = function(Name)
    local getasset = getsynasset or getcustomasset
        spawn(function()
            local code = game:HttpGet("https://raw.githubusercontent.com/409080586020275198131518482925150672705/jfewiuf8euf03ur89uwe8rufuw3yhfujeu3h8f/main/Assets/"..Name..".png")
